...
export function NotificationSettings({ settings, onUpdateSetting, loading }: NotificationSettingsProps) {
          ...
          {getSetting('email_notifications_enabled') && (
            <div className="space-y-3">
              ...
              {localValues['email_notifications_enabled'] !== undefined && (
                <Button 
                  size="sm" 
                  onClick={() => handleSave('email_notifications_enabled')}
                  disabled={loading}
                >
                  Save
                </Button>
          ...
          {getSetting('booking_confirmation_email') && (
            <div className="space-y-3">
              ...
              {localValues['booking_confirmation_email'] !== undefined && (
                <Button 
                  size="sm" 
                  onClick={() => handleSave('booking_confirmation_email')}
                  disabled={loading}
                >
                  Save
                </Button>
          ...
          {getSetting('admin_notification_email') && (
            <div className="space-y-2">
              <Label htmlFor="admin_notification_email" className="flex items-center gap-2">
                ...
                {getSetting('admin_notification_email')?.is_required && <span className="text-red-500">*</span>}
              </Label>
              <Input
              ...
              {localValues['admin_notification_email'] !== undefined && (
                <Button 
                  size="sm" 
                  onClick={() => handleSave('admin_notification_email')}
                  disabled={loading}
                >
                  Save
                </Button>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className={getValue('email_notifications_enabled') && getValue('booking_confirmation_email') ? 'text-green-600' : 'text-gray-400'}>
                    {getValue('email_notifications_enabled') && getValue('booking_confirmation_email') ? '✓ Enabled' : '✗ Disabled'}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className={getValue('admin_notification_email') ? 'text-green-600' : 'text-gray-400'}>
