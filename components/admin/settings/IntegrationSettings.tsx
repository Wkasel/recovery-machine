...
export function IntegrationSettings({ settings, onUpdateSetting, loading }: IntegrationSettingsProps) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure Bolt payment processing integration.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {getSetting('bolt_public_key') && (
              <div className="space-y-2">
                <Label htmlFor="bolt_public_key">
                  {getSetting('bolt_public_key')?.label}
                </Label>
                <Input
                  id="bolt_public_key"
                  type="text"
                ...
                {localValues['bolt_public_key'] !== undefined && (
                  <Button 
                    size="sm" 
                    onClick={() => handleSave('bolt_public_key')}
                    disabled={loading}
                  >
                    Save
                  </Button>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder={getValue('bolt_webhook_secret') ? maskSecret(getValue('bolt_webhook_secret')) : 'whsec_...'}
                  />
                  <Button
                    type="button"
                    variant="ghost"
                  ...
                  >
                    {showSecrets['bolt_webhook_secret'] ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                  </Button>
                </div>
                <p className="text-xs text-gray-500">
                ...
                {localValues['bolt_webhook_secret'] !== undefined && (
                  <Button 
                    size="sm" 
                    onClick={() => handleSave('bolt_webhook_secret')}
                    disabled={loading}
                  >
                    Save
                  </Button>
            ...
            {getSetting('google_api_key') && (
              <div className="space-y-2">
                <Label htmlFor="google_api_key">
                  {getSetting('google_api_key')?.label}
                </Label>
                <div className="relative">
                  <Input
                    id="google_api_key"
                    ...
                    placeholder={getValue('google_api_key') ? maskSecret(getValue('google_api_key')) : 'AIza...'}
                  />
                  <Button
                    type="button"
                    variant="ghost"
                  ...
                  >
                    {showSecrets['google_api_key'] ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                  </Button>
                </div>
                <p className="text-xs text-gray-500">
                  {getSetting('google_api_key')?.description}
                </p>
                {localValues['google_api_key'] !== undefined && (
                  <Button 
                    size="sm" 
                    onClick={() => handleSave('google_api_key')}
                    disabled={loading}
                  >
                    Save
                  </Button>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              SMS notifications and communication via Twilio.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {/* Twilio Account SID */}
            {getSetting('twilio_account_sid') && (
              <div className="space-y-2">
                ...
                {localValues['twilio_account_sid'] !== undefined && (
                  <Button 
                    size="sm" 
                    onClick={() => handleSave('twilio_account_sid')}
                    disabled={loading}
                  >
                    Save
                  </Button>
            ...
            {getSetting('twilio_auth_token') && (
              <div className="space-y-2">
                <Label htmlFor="twilio_auth_token">
                  {getSetting('twilio_auth_token')?.label}
                </Label>
                <div className="relative">
                  <Input
                    ...
                    placeholder={getValue('twilio_auth_token') ? maskSecret(getValue('twilio_auth_token')) : 'Auth Token'}
                  />
                  <Button
                    type="button"
                    variant="ghost"
                ...
                {localValues['twilio_auth_token'] !== undefined && (
                  <Button 
                    size="sm" 
                    onClick={() => handleSave('twilio_auth_token')}
                    disabled={loading}
                  >
                    Save
                  </Button>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Social media integrations for marketing and content.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder={getValue('instagram_access_token') ? maskSecret(getValue('instagram_access_token')) : 'Access Token'}
                  />
                  <Button
                    type="button"
                    variant="ghost"
                  ...
                  >
                    {showSecrets['instagram_access_token'] ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                  </Button>
                </div>
                <p className="text-xs text-gray-500">
                ...
                {localValues['instagram_access_token'] !== undefined && (
                  <Button 
                    size="sm" 
                    onClick={() => handleSave('instagram_access_token')}
                    disabled={loading}
                  >
                    Save
                  </Button>
