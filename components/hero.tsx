      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 bg-neutral-900 px-4 py-2 border border-neutral-800">
            ...
            <span className="text-neutral-300 text-sm font-mono">4.8/5 · 500+ recoveries delivered</span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <Button asChild className="bg-white text-black hover:bg-neutral-200 text-lg font-medium h-12 px-8 border-0">
