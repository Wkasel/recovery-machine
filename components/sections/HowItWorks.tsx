...
import { CheckCircle, MapPin, Repeat, UserPlus, ArrowRight, Sparkles, Clock, Award } from 'lucide-react';
...
const steps = [
  {
    icon: UserPlus,
    title: 'Sign Up',
    description: 'Create your account and choose your membership plan. Setup takes less than 5 minutes.',
    duration: '< 5 min',
  },
  {
    icon: MapPin,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-neutral-400 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="font-semibold text-white">Simple, convenient, effective.</span>
          </p>
        </div>
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <Card className={`relative border bg-black h-full p-8 ${
        ...
        <div className="bg-black border border-neutral-800 p-8 mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-neutral-400 text-lg">Commercial-grade recovery delivered to your door</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-neutral-400 text-sm">Professional setup arrives at your location</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-neutral-400 text-sm">Precision temperature control for optimal recovery</p>
            </div>
        ...
        <div className="bg-black border border-neutral-800 p-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-neutral-400 text-sm">We handle everything from arrival to cleanup</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-neutral-400 text-sm">Commercial-grade cold plunge and infrared sauna</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-neutral-400 text-sm">Certified recovery specialists guide every session</p>
            </div>
          </div>
        </div>
      </div>
