...
export const wellnessServices: ServiceOffering[] = [
  {
    ...
    description: "Professional cold plunge sessions delivered to your location for enhanced recovery and performance",
  ...
  },
  {
    ...
    description: "Premium infrared sauna sessions at your location for detoxification and relaxation",
