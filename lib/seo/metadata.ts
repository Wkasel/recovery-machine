...
export function generateSEOMetadata({
  ...
  const allKeywords = [...keywords, ...generateMetaKeywords(pageType).split(", ")].filter(
...
export const homePageMetadata = generateSEOMetadata({
  ...
  description:
    "The Recovery Machine delivers professional cold plunge and infrared sauna sessions to your location in Los Angeles. Weekly wellness programs for peak performance and recovery.",
  pageType: "home",
  keywords: [
...
export const servicesPageMetadata = generateSEOMetadata({
  ...
  description:
    "Professional cold plunge therapy and infrared sauna sessions delivered to your door. Experience the benefits of recovery therapy at your location.",
  pageType: "services",
  path: "/services",
  keywords: [
    "cold plunge therapy",
...
export const bookingPageMetadata = generateSEOMetadata({
  ...
  description:
    "Schedule your mobile cold plunge or infrared sauna session. Easy online booking for recovery therapy delivered to your Los Angeles location.",
  pageType: "booking",
  path: "/booking",
  keywords: [
