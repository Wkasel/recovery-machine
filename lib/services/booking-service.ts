...
import { AvailabilitySlot, DatabaseBooking, BookingFormData, Address, SetupFeeCalculation } from '@/lib/types/booking'
...
export class BookingService {
  ...
  static async checkConflicts(dateTime: string, duration: number, userId?: string): Promise<boolean> {
    try {
  ...
  static async createBooking(bookingData: BookingFormData, userId: string): Promise<DatabaseBooking | null> {
    try {
