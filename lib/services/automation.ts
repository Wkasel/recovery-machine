...
import { sendBookingConfirmationSMS, sendSessionCompleteSMS } from "@/lib/services/sms";
import type { ApiResponse, Booking, Profile, Referral } from "@/lib/types/supabase";
    ...
    for (const action of workflow.actions) {
      ...
      try {
        ...
        execution.error_message =
          actionError instanceof Error ? actionError.message : "Action execution failed";
...
export function validateWorkflowConditions(conditions: AutomationCondition[], data: any): boolean {
