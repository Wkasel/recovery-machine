...
export default function ProfilePage() {
  ...
  const renderActiveTab = () => {
    switch (activeTab) {
      case "overview":
        return <Overview user={user} profileData={profileData} onRefresh={refreshProfileData} />;
      case "bookings":
        return <BookingsTab user={user} onRefresh={refreshProfileData} />;
      case "history":
        return <HistoryTab user={user} />;
      case "referrals":
        return (
          <ReferralsTab user={user} profileData={profileData} onRefresh={refreshProfileData} />
        );
      case "reviews":
        return <ReviewsTab user={user} />;
      case "settings":
        return (
          <ProfileSettings user={user} profileData={profileData} onRefresh={refreshProfileData} />
        );
      default:
        return null;
    }
